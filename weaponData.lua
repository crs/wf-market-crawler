...
["IgnoreInCount"] = {"Rampart", "Dark Split-Sword (Heavy Blade)", "Dark Split-Sword (Dual Swords)", "Cadus", "Carmine Penta", "Prisma Machete"},
["Weapons"] = {
    ["Ack & Brunt"] = {
        Name = "Ack & Brunt",
		Cost = {
	...
	["Destreza Prime"] = {
		...
		Introduced = "[[Update 23#Hotfix 23.0.3|Update 23.0.3]]",
		JumpAttack = 152,
		Mastery = 10,
		Name = "Destreza Prime",
		NormalAttack = {
	...
	["Kronen Prime"] = {
		...
		Introduced = "[[Update 22#Update 22.16.4|Update 22.16.4]]",
		JumpAttack = 132,
		Mastery = 8,
		Name = "Kronen Prime",
		NormalAttack = {
	...
	["Tigris Prime"] = {
		...
		NormalAttack = {
			...
			PelletCount = 8,
			FireRate = 2,
			Falloff = {StartRange = 8,EndRange = 20,Reduction = 0.4872,},
			ShotType = "Hit-Scan",
		},
		Polarities = {"V", "Bar"},
		Reload = 1.8,
