...
var WEAPON_MELEE = require('../constants.js').ITEM_TYPE.WEAPON_MELEE;
...
var _require$MELEE_CATEGO = require('../constants.js').MELEE_CATEGORIES,
    BLADE_WHIP = _require$MELEE_CATEGO.BLADE_WHIP,
    CLAWS = _require$MELEE_CATEGO.CLAWS,
    DAGGER = _require$MELEE_CATEGO.DAGGER,
    DUAL_DAGGERS = _require$MELEE_CATEGO.DUAL_DAGGERS,
    DUAL_SWORDS = _require$MELEE_CATEGO.DUAL_SWORDS,
    FIST = _require$MELEE_CATEGO.FIST,
    GLAIVE = _require$MELEE_CATEGO.GLAIVE,
    GUNBLADE = _require$MELEE_CATEGO.GUNBLADE,
    HAMMER = _require$MELEE_CATEGO.HAMMER,
    HEAVY_BLADE = _require$MELEE_CATEGO.HEAVY_BLADE,
    HYBRID = _require$MELEE_CATEGO.HYBRID,
    MACHETE = _require$MELEE_CATEGO.MACHETE,
    NIKANA = _require$MELEE_CATEGO.NIKANA,
    NUNCHAKU = _require$MELEE_CATEGO.NUNCHAKU,
    POLEARM = _require$MELEE_CATEGO.POLEARM,
    RAPIER = _require$MELEE_CATEGO.RAPIER,
    SCYTHE = _require$MELEE_CATEGO.SCYTHE,
    SPARRING = _require$MELEE_CATEGO.SPARRING,
    STAFF = _require$MELEE_CATEGO.STAFF,
    SWORD = _require$MELEE_CATEGO.SWORD,
    SWORD_SHEILD = _require$MELEE_CATEGO.SWORD_SHEILD,
    TONFA = _require$MELEE_CATEGO.TONFA,
    WARFANS = _require$MELEE_CATEGO.WARFANS,
    WHIP = _require$MELEE_CATEGO.WHIP;

var STALKER = ENEMY.STALKER,
    VOR = ENEMY.VOR;
...
var THE_SECOND_DREAM = QUEST.THE_SECOND_DREAM,
    THE_WAR_WITHIN = QUEST.THE_WAR_WITHIN;
var ALERTS = REWARD.ALERTS,
    ANNIVERSARY = REWARD.ANNIVERSARY,
    CETUS_BOUNTY_40_60 = REWARD.CETUS_BOUNTY_40_60,
    LOGIN_REWARD = REWARD.LOGIN_REWARD,
    OPERATION_PLAGUE_STAR = REWARD.OPERATION_PLAGUE_STAR,
...
module.exports = weaponMelees.map(function (object) {
  return _extends({}, object, { type: WEAPON_MELEE });
});